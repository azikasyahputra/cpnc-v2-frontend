...
<head>
<meta charset="UTF-8">
<title>Invoice Trucking <?php echo e($header->first()->no_invoice ?? ''); ?></title>
<style type="text/css">
...
?>
    ...
    <table class="no-border">
        <tr>
            <td class="bold" style="font-size:13px;"><?php echo e($head->nama_client ?? ''); ?></td>
        </tr>
    </table>
    <br>
    <table class="bordered">
        ...
        <tbody>
            ...
            <tr>
                <td class="center"><?php echo e($head->no_aju ?? ''); ?></td>
                <td class="center"><?php echo e($row->tanggal_order); ?></td>
                <td><?php echo e($row->tujuan); ?></td>
                <td><?php echo e($row->party); ?></td>
                <td><?php echo e($row->container); ?></td>
                <td class="right"><?php echo e(number_format((int) $row->ongkos, 0, ',', '.')); ?></td>
                <td class="right"><?php echo e(number_format((int) $row->uang_bongkar, 0, ',', '.')); ?></td>
                <td class="right"><?php echo e(number_format((int) $row->lift_off, 0, ',', '.')); ?></td>
                <td class="right"><?php echo e(number_format($tagihan, 0, ',', '.')); ?></td>
            </tr>
        ...
        <tfoot>
            <tr class="bold">
                ...
                <td class="right"><?php echo e(number_format($total, 0, ',', '.')); ?></td>
            </tr>
        </tfoot>
    </table>
</body>
</html>
<?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/invoicetrucking/invoice.blade.php ENDPATH**/ ?>