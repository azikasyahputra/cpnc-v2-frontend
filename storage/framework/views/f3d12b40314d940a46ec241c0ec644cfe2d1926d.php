        ...
        <div class="row g-3">
            <?php $__currentLoopData = $filterable; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-3 col-sm-6">
                    ...
                    <input type="text" wire:model.debounce.500ms="filters.<?php echo e($column['name']); ?>" class="form-control form-control-sm" placeholder="<?php echo e($column['label']); ?>">
                </div>
                    ...
                    <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <th class="text-white" style="font-weight:600;font-size:12px;<?php echo e(isset($column['width']) ? 'width:'.$column['width'].';' : ''); ?><?php echo e($i === $lastIdx && $column['name'] === 'Action' ? 'position:sticky;right:0;background:#696cff;box-shadow:inset 0 0 0 9999px #696cff;z-index:2;' : ''); ?>">
                            <?php if(! empty($column['sortable'])): ?>
                                <a href="#" wire:click.prevent="sortBy('<?php echo e($column['name']); ?>')" class="text-white"><?php echo e($column['label']); ?>
    ...
    <div class="card-footer d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
        <nav aria-label="Page navigation">
            <ul class="pagination pagination-sm mb-0">
                ...
                <li class="page-item <?php echo e($page <= 1 ? 'disabled' : ''); ?>">
                    <a class="page-link" href="#" wire:click.prevent="gotoPage(<?php echo e($page > 1 ? $page - 1 : 1); ?>)"><i class="bx bx-chevron-left"></i></a>
                </li>
                <?php
                    $start = max(1, $page - 2);
                ...
                <?php for($p = $start; $p <= $end; $p++): ?>
                    <li class="page-item <?php echo e($p === $page ? 'active' : ''); ?>">
                        <a class="page-link" href="#" wire:click.prevent="gotoPage(<?php echo e($p); ?>)"><?php echo e($p); ?></a>
                    </li>
                <?php endfor; ?>
                <li class="page-item <?php echo e($page >= $lastPage ? 'disabled' : ''); ?>">
                    <a class="page-link" href="#" wire:click.prevent="gotoPage(<?php echo e($page < $lastPage ? $page + 1 : $lastPage); ?>)"><i class="bx bx-chevron-right"></i></a>
                </li>
                <li class="page-item <?php echo e($page >= $lastPage ? 'disabled' : ''); ?>">
                    <a class="page-link" href="#" wire:click.prevent="gotoPage(<?php echo e($lastPage); ?>)"><i class="bx bx-chevrons-right"></i></a>
                </li>
            </ul>
        </nav>
...
<?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc-v2-frontend/resources/views/livewire/index-table.blade.php ENDPATH**/ ?>