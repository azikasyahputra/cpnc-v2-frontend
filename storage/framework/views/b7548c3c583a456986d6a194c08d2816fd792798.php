...
<?php $__env->startSection('content'); ?>
    <div class="col-md-12 col-sm-12 col-12">
        <form action="<?php echo e(URL::route('ordersave')); ?>" method="post">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <?php $__currentLoopData = $jenisdokumen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenisdokumen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($jenisdokumen->id_jenis_dokumen); ?>"><?php echo e($jenisdokumen->nama_dokumen); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                             ...
                             <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <select id="id_pelayaran" name="id_pelayaran" class="selectkas form-control" required>
                                        ...
                                        <option value="<?php echo e($pelayaran->id_pelayaran); ?>"><?php echo e($pelayaran->nama_pelayaran); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <select id="id_lapangan" name="id_lapangan" class="selectkas form-control" required>
                                        ...
                                        <option value="<?php echo e($lapangan->id_lapangan); ?>"><?php echo e($lapangan->nama_lapangan); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <select id="id_gudang" name="id_gudang" class="selectkas form-control" required>
                                        ...
                                        <option value="<?php echo e($gudang->id_gudang); ?>"><?php echo e($gudang->nama_gudang); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <select id="id_kosongan" name="id_kosongan" class="selectkas form-control" required>
                                        ...
                                        <option value="<?php echo e($kosongan->id_kosongan); ?>"><?php echo e($kosongan->nama_kosongan); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    <select id="id_status" name="id_status" class="form-control" required>
                                        ...
                                        <option value="<?php echo e($status->id_status); ?>"><?php echo e($status->nama_status); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/order/create.blade.php ENDPATH**/ ?>