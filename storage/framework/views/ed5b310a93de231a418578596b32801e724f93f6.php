    ...
    <div class="card-footer d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
        <nav aria-label="Page navigation">
            <ul class="pagination pagination-sm mb-0">
                ...
                <li class="page-item <?php echo e($page <= 1 ? 'disabled' : ''); ?>">
                    <a class="page-link" href="#" wire:click.prevent="gotoPage(<?php echo e($page - 1); ?>)"><i class="bx bx-chevron-left"></i></a>
                </li>
                <?php
                    $start = max(1, $page - 2);
                ...
                <li class="page-item <?php echo e($page >= $lastPage ? 'disabled' : ''); ?>">
                    <a class="page-link" href="#" wire:click.prevent="gotoPage(<?php echo e($page + 1); ?>)"><i class="bx bx-chevron-right"></i></a>
                </li>
                <li class="page-item <?php echo e($page >= $lastPage ? 'disabled' : ''); ?>">
...
<?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/livewire/index-table.blade.php ENDPATH**/ ?>