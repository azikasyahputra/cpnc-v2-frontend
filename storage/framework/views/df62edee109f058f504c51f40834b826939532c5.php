...
<div class="col-md-12 col-sm-12 col-12">
        <form action="<?php echo e(URL::route('invoicesave')); ?>" method="post">
            ...
            <input type="hidden" name="id_client" value="<?php echo e($order->id_client); ?>">
            <input type="hidden" name="no_aju" value="<?php echo e($order->no_aju); ?>">
            <input type="hidden" name="id_jenis_dokumen" value="<?php echo e($order->id_jenis_dokumen); ?>">
        <div class="card">
            <div class="card-body">
                <div id="order">
                    <div class="card-body">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-8 mb-3 "> 
                                            <input type="text" id="nama_client" class="form-control" name="nama_client" value="<?php echo e($order->nama_client); ?>" readonly />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-8 mb-3 "> 
                                            <input type="text" id="alamat_client" class="form-control" name="alamat_client" value="<?php echo e($order->nama_client); ?> <?php echo e($order->kodepos_client); ?>" readonly />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-8 mb-3 "> 
                                            <input type="text" id="kota_client" class="form-control" name="kota_client" value="<?php echo e($order->kota_client); ?>" readonly />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-4 col-sm-4 col-xs-4 mb-3 ">
                                            <input type="text" id="no_bl" class="form-control" name="no_bl" value="<?php echo e($order->nama_bl); ?>" readonly />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <table class="table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <input type="text" id="ex_kapal" class="form-control" name="ex_kapal" value="<?php echo e($order->nama_kapal_pesawat); ?>" readonly />
                                            </td>
                                            <td>
                                                <input type="text" id="pel_tujuan_negara_asal" class="form-control" name="pel_tujuan_negara_asal" value="<?php echo e($order->negara_asal_tujuan); ?>" readonly />
                                            </td>
                                            <td>
                                                <input type="text" id="pelayaran" class="form-control" name="pelayaran" value="<?php echo e($order->nama_pelayaran); ?>" readonly />
                                            </td>
                                            <td>
                                                <?php
                                                ...
                                                ?>
                                                <input type="text" id="berangkat_tiba" class="form-control" name="berangkat_tiba" value="<?php echo e($tanggal_kapal_pesawat); ?>" readonly />
                                            </td>
                                            <td>
                                                <input type="text" id="banyaknya_kemasan" class="form-control" name="banyaknya_kemasan" value="<?php echo e($order->kemasan); ?>" readonly />
                                            </td>
                                            <td>
                                                <input type="text" id="nama_barang" class="form-control" name="nama_barang" value="<?php echo e($order->nama_barang); ?>" readonly />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/invoice/create.blade.php ENDPATH**/ ?>