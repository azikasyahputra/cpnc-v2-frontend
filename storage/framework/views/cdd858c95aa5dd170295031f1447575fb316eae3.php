                  ...
                  <div class="page-header float-end">
                      <div class="page-title">
                          <ol class="breadcrumb text-end">
                              ...
                              <li class="active">Detail Order Trucking</li>
                          </ol>
                      </div>
                  </div>
              </div>
            ...
            <form id="demo-form" class="form-horizontal">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                          ...
                          <input type="text" id="uang_kasbon_jalan" class="form-control text-end" name="uang_kasbon_jalan" value="<?php echo e($data->kasbon_uang_jalan); ?>" readonly />
                    </div>
                    <?php endif; ?>
                </div>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-12 mb-3 ">
                      <a href="<?php echo e(URL::route('trucking')); ?>" class="btn btn-danger">Kembali</a>
                    </div>  
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/trucking/detail.blade.php ENDPATH**/ ?>