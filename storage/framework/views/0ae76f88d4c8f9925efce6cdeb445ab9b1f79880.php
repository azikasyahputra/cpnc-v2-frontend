        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item <?php echo e(request()->is('user*') ? 'active' : ''); ?>"><a class="menu-link" href="<?php echo e(URL::route('user')); ?>"><div data-i18n="User">User</div></a></li>
                    <li class="menu-item <?php echo e(request()->is('role*') ? 'active' : ''); ?>"><a class="menu-link" href="<?php echo e(URL::route('role')); ?>"><div data-i18n="Role">Role</div></a></li>
                    <?php endif; ?>
...
<?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc-v2-frontend/resources/views/layout/main_layout.blade.php ENDPATH**/ ?>