                    ...
                    <form action="<?php echo e(URL::route('pengeluaransaveedit')); ?>" method="post">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                <?php $__currentLoopData = $referensi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $referensi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 mb-3 "> 
                                        ...
                                        <input type="text" id="pendapatan" class="form-control text-end" name="pendapatan" value="<?php echo e($header->pendapatan); ?>" readonly />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 mb-3 "> 
                                        ...
                                        <input type="text" id="piutang" class="form-control text-end" name="piutang" value="<?php echo e($header->piutang); ?>" readonly />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 mb-3 "> 
                                        ...
                                        <input type="text" id="kas" class="form-control text-end" name="kas" value="<?php echo e($header->kas); ?>" readonly />
                                    ...
                                    <?php $no=1; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" id="jumlah_biaya_<?php echo e($no); ?>" class="cost form-control text-end" name="jumlah_biaya_<?php echo e($no); ?>" value="<?php echo e($detaildata->biaya_detail); ?>" readonly/>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="sum" class="form-control text-end" name="jumlah_pendapatan" value="<?php echo e($header->jumlah_biaya); ?>" readonly /></td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-12 mb-3 ">
                                ...
                                <a href="<?php echo e(URL::route('pengeluaran')); ?>" class="btn btn-danger">Kembali</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/pengeluaran/detail.blade.php ENDPATH**/ ?>