...
<div class="col-md-12 col-sm-12 col-12">
    <div class="card">
        <div class="card-body">
            <div id="order">
                <div class="card-body">
                    <form action="<?php echo e(URL::route('pengeluaransave')); ?>" method="post">
                        ...
                        <input type="hidden" name="id_client" value="<?php echo e($header->id_client); ?>">
                        <div class="row">
                        ...
                        <div class="row">
                            <table class="table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <input type="text" id="ex_kapal" class="form-control" name="ex_kapal" value="<?php echo e($header->nama_kapal_pesawat); ?>" required />
                                        </td>
                                        <td>
                                            <input type="text" id="pel_tujuan_negara_asal" class="form-control" name="pel_tujuan_negara_asal" value="<?php echo e($header->negara_asal_tujuan); ?>" required />
                                        </td>
                                        <td>
                                            <input type="text" id="pelayaran" class="form-control" name="pelayaran" value="<?php echo e($header->nama_pelayaran); ?>" required />
                                        </td>
                                        <td>
                                            <input type="text" id="berangkat_tiba" class="form-control" name="berangkat_tiba" value="<?php echo e($header->tanggal_kapal_pesawat); ?>" required />
                                        </td>
                                        <td>
                                            <input type="text" id="banyaknya_kemasan" class="form-control" name="banyaknya_kemasan" value="<?php echo e($header->kemasan); ?>" required />
                                        </td>
                                        <td>
                                            <input type="text" id="nama_barang" class="form-control" name="nama_barang" value="<?php echo e($header->nama_barang); ?>" required />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="row">
                            <table class="table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                    <input type="hidden" name="id_invoice_dt_<?php echo e($no); ?>" value="<?php echo e($detaildata->id_invoice_dt); ?>" />
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" id="sum" class="form-control text-end" name="jumlah_pendapatan" value="<?php echo e($header->jumlah_biaya); ?>" required /></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/pengeluaran/create.blade.php ENDPATH**/ ?>