                        ...
                        <form action="<?php echo e(URL::route('invoicesaveedit')); ?>" method="post">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-4 col-sm-4 col-xs-4 mb-3 ">
                                            ...
                                            ?>
                                            <input type="text" id="tanggal_invoice" class="form-control" name="tanggal_invoice" value="<?php echo e($tanggal_invoice); ?>" readonly />
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                    <div class="row">
                                        <div class="col-lg-5 col-md-2 col-sm-2 col-xs-2 mb-3 ">
                                            <input type="text" id="kode_jenis_invoice" class="form-control" name="kode_jenis_invoice" value="<?php echo e($header->kode_jenis_invoice); ?>" readonly />
                                        </div>
                                        <div class="col-lg-6 col-md-4 col-sm-4 col-xs-4 mb-3 ">
                            ...
                            <div class="row">
                                <table class="table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" id="no_kwitansi" class="form-control" name="no_kwitansi_<?php echo e($no); ?>" value="<?php echo e($detaildata->no_kwitansi); ?>" readonly/>
                                            </td>
                                            <td style="width:520px">
                                                    <?php $__currentLoopData = $biayadetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $biaya2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <input type="text" id="biaya_<?php echo e($no); ?>" name="biaya_<?php echo e($no); ?>" class="form-control" value="<?php echo e($biaya2->nama_biaya); ?>" readonly/>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </td>
                                            <td>
                                                <input type="text" id="jumlah_biaya_<?php echo e($no); ?>" class="form-control text-end" style="text-align:right" name="jumlah_biaya_<?php echo e($no); ?>" value="<?php if($detaildata->biaya_detail != 0){echo 'Rp. '.number_format($detaildata->biaya_detail,0,'','.');}else{echo $detaildata->biaya_detail;}?>" readonly/>
                                            </td>
                                            <td>
                                                <input type="text" id="keterangan_<?php echo e($no); ?>" class="form-control" name="keterangan_<?php echo e($no); ?>" value="<?php echo e($detaildata->keterangan); ?>" readonly/>
                                            </td>
                                        </tr>
                                        <?php $no++;?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" id="no_kwitansi" class="form-control" name="no_kwitansi_<?php echo e($i); ?>" readonly/>
                                            </td>
                                            <td style="width:520px">
                                                <input id="biaya_<?php echo e($i); ?>" name="biaya_<?php echo e($i); ?>" class="form-control" value="-" readonly />
                                            </td>
                                            <td>
                                                <input type="text" id="jumlah_biaya_<?php echo e($i); ?>" class="cost form-control text-end" name="jumlah_biaya_<?php echo e($i); ?>" readonly/>
                                            </td>
                                            <td>
                                                <input type="text" id="keterangan_<?php echo e($i); ?>" class="form-control" name="keterangan_<?php echo e($i); ?>" readonly/>
                                            </td>
                                        </tr>
                                        <?php $i++;?>
                                        <?php endwhile; ?>
                                        <tr>
                                            ...
                                            <td><input type="text" id="keterangan" class="form-control" name="keterangan_pendapatan" value="<?php echo e($header->keterangan_jumlah_biaya); ?>" readonly/></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 mb-3 ">
                                    <input type="text" id="terbilang" class="form-control" name="terbilang" value="<?php echo e($header->biaya_terbilang); ?>" readonly />
                                </div>
                                <div class="col-md-12 col-sm-12 col-12 mb-3 ">
                                    <br>
                                    <a href="<?php echo e(URL::route('downloadinvoice',['id'=>$header->id_invoice])); ?>" class="btn btn-success" target="_blank">Print</a>
                                    <a href="<?php echo e(URL::route('downloadkwitansi',['id'=>$header->id_invoice])); ?>" class="btn btn-primary" target="_blank">Print Kwitansi</a>
                                    <a href="<?php echo e(URL::route('invoice')); ?>" class="btn btn-danger">Kembali</a>
                                </div>   
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </form>
...
<?php echo $__env->make('layout.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/invoice/detail.blade.php ENDPATH**/ ?>