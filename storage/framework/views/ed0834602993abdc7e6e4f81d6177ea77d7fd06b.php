...
<div class="col-md-12 col-sm-12 col-12">
    ...
    <form action="<?php echo e(URL::route('invoicetruckingsaveedit')); ?>" method="post" id="formInvoiceTrucking">
        <?php echo e(csrf_field()); ?>

        <input type="hidden" name="id_invoice_trucking" value="<?php echo e($data->id_invoice_trucking); ?>" />
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-3">
                        ...
                        <input type="text" id="tanggal_invoice" class="form-control" name="tanggal_invoice" value="<?php echo e($tgl ? $tgl->format('d/m/Y') : ''); ?>" required />
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-3">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table table-bordered" id="detailTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center no"><?php echo e($index + 1); ?></td>
                                <td>
...
<?php echo $__env->make('layout.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/invoicetrucking/edit.blade.php ENDPATH**/ ?>