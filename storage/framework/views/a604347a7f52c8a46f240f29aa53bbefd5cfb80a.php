                  ...
                  <div class="page-header float-end">
                      <div class="page-title">
                          <ol class="breadcrumb text-end">
                              ...
                              <li class="active">Laporan Keseluruhan</li>
                          </ol>
                      </div>
                  </div>
              </div>
...
<div class="col-md-12 col-sm-12 col-12">
    <div class="card">
        <div class="card-body">
            <form action="<?php echo e(URL::route('downloadlaporankeseluruhan')); ?>" method="post">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/laporanpiutang/indexlaporankeseluruhan.blade.php ENDPATH**/ ?>