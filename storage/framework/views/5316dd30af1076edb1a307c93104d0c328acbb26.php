...
<div class="col-md-12 col-sm-12 col-12">
    <form class="form-horizontal" action="<?php echo e(URL::route('kassave')); ?>" method="post">
                    ...
                    <table class="table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" id="debit_<?php echo e($i); ?>" class="cost" name="debit_<?php echo e($i); ?>"/>
                                    <input type="text" id="show_debit_<?php echo e($i); ?>" class="form-control text-end" name="show_debit_<?php echo e($i); ?>" onkeyup="formatRupiah(event)"/>
                                </td>
                                <td>
                                    <input type="hidden" id="kredit_<?php echo e($i); ?>" class="cost2" name="kredit_<?php echo e($i); ?>"/>
                                    <input type="text" id="show_kredit_<?php echo e($i); ?>" class="form-control text-end" name="show_kredit_<?php echo e($i); ?>" onkeyup="formatRupiah(event)"/>
                                </td>
                            </tr>
                            <?php $i++;?>
                            <?php endwhile; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/bukukas/create.blade.php ENDPATH**/ ?>