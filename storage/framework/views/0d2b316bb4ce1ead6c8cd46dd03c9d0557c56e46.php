...
<body>
  ...
  <table width="100%">
      ...
      <tr>
        ...
        <td class="propertyisi" width="10%" align="right"><?php echo e(number_format($totalpendapatanjasa,0,'','.')); ?></td>
       ...
       <tr>
        ...
        <td class="propertyisi" width="10%" align="right"><?php echo e(number_format($totalpendapatanoperasional,0,'','.')); ?></td>
       ...
       <tr>
        ...
        <td class="propertyisi" width="10%" align="right"><?php echo e(number_format($totalpendapatantrucking,0,'','.')); ?></td>
      ...
      <tr>
        ...
        <td class="propertyisi" width="18%" align="right"><?php echo e(number_format($totallababruto,0,'','.')); ?></td>
      ...
      <tr>
        ...
        <td class="propertyisi" width="18%" align="right"><strong><?php echo e(number_format($totallababruto,0,'','.')); ?></strong></td>
      ...
      <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $databiaya): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

      <tr>

        <td class="propertyheader" align="right" style="border-right: 0px;" width="10%">Biaya&nbsp;</td>

        <td class="propertyisi" width="40%">&nbsp;<?php echo e($databiaya['nama_biaya']); ?></td>

        <td class="propertyisi" width="10%" align="right"></td>

        <td class="propertyisi" width="18%" align="right"><?php echo e(number_format($databiaya['jumlah_biaya'],0,'','.')); ?></td>
      ...
      <tr>
        ...
        <td class="propertyisi" width="18%" align="right"><strong><?php echo e(number_format($totalbiaya,0,'','.')); ?></strong></td>
      ...
      <tr>
         ...
         <td class="propertyisi" width="18%" align="right"><strong><?php echo e(number_format($labarugineto,0,'','.')); ?></strong></td>
      ...
      <tr>
         ...
         <td class="propertyisi" width="18%" align="right"><strong><?php echo e(number_format($totalpenghasilanluarusaha,0,'','.')); ?></strong></td>
      ...
      <tr>
         ...
         <td class="propertyisi" width="18%" align="right"><strong><?php echo e(number_format($totalbiayaluarusaha,0,'','.')); ?></strong></td>
...
</html><?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/laporankeuangan/laporanrugilabakeuangan.blade.php ENDPATH**/ ?>