...
<?php $__env->startSection('content'); ?>
    <div class="col-md-12 col-sm-12 col-12">
        <form action="<?php echo e(URL::route('ordersaveedit')); ?>" method="post">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="kemasan" class="form-control" name="kemasan" value="<?php echo e($data->kemasan); ?>" />
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    <label for="no_container">No.Container* :</label>
                                    <input type="text" id="no_container" class="form-control" name="no_container" value="<?php echo e($data->no_container); ?>" required />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <?php $__currentLoopData = $jenisdokumen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenisdokumen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($jenisdokumen->id_jenis_dokumen); ?>" <?php if($data->id_jenis_dokumen==$jenisdokumen->id_jenis_dokumen): ?> selected <?php endif; ?>><?php echo e($jenisdokumen->nama_dokumen); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="nama_kapal_pesawat" class="form-control" name="nama_kapal_pesawat" value="<?php echo e($data->nama_kapal_pesawat); ?>" required />
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="tanggal_kapal_pesawat" class="form-control" name="tanggal_kapal_pesawat" value="<?php echo e($tanggal_kapal_pesawat); ?>" required />
                                </div>
                            </div>
                             ...
                             <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <?php $__currentLoopData = $pelayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pelayaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($pelayaran->id_pelayaran); ?>" <?php if($data->id_pelayaran==$pelayaran->id_pelayaran): ?> selected <?php endif; ?>><?php echo e($pelayaran->nama_pelayaran); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <?php $__currentLoopData = $lapangan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lapangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($lapangan->id_lapangan); ?>" <?php if($data->id_lapangan==$lapangan->id_lapangan): ?> selected <?php endif; ?>><?php echo e($lapangan->nama_lapangan); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <?php $__currentLoopData = $gudang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gudang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($gudang->id_gudang); ?>" <?php if($data->id_gudang==$gudang->id_gudang): ?> selected <?php endif; ?>><?php echo e($gudang->nama_gudang); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="nama_barang" class="form-control" name="nama_barang" value="<?php echo e($data->nama_barang); ?>" required />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    <label for="nama_bl">BL* :</label>
                                    <input type="text" id="nama_bl" class="form-control" name="nama_bl" value="<?php echo e($data->nama_bl); ?>" required />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    <label for="nama_pos">Pos* :</label>
                                    <input type="text" id="nama_pos" class="form-control" name="nama_pos" value="<?php echo e($data->nama_pos); ?>" required />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <?php $__currentLoopData = $kosongan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kosongan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($kosongan->id_kosongan); ?>" <?php if($data->id_kosongan==$kosongan->id_kosongan): ?> selected <?php endif; ?>><?php echo e($kosongan->nama_kosongan); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($status->id_status); ?>" <?php if($data->id_status==$status->id_status): ?> selected <?php endif; ?>><?php echo e($status->nama_status); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="tanggal_status" class="form-control" name="tanggal_status" value="<?php echo e($tanggal_status); ?>" required />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    <label for="negara_asal">Negara Asal/Tujuan* :</label>
                                    <input type="text" id="negara_asal_tujuan" class="form-control" name="negara_asal_tujuan" value="<?php echo e($data->negara_asal_tujuan); ?>" required />
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/order/edit.blade.php ENDPATH**/ ?>