            ...
            <div class="authentication-inner">
                <div class="card">
                    <div class="card-body">
                        <div class="app-brand justify-content-center">
                            <a href="/" class="app-brand-link gap-2">
                                <span class="d-inline-flex align-items-center justify-content-center" style="padding:10px 20px;">
                                    <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Logo" class="img-fluid" style="max-height:60px;max-width:100%;" />
                                </span>
                            </a>
                        </div>
                        ...
                        <form id="formAuthentication" class="mb-3" action="<?php echo e(URL::route('checklogin')); ?>" method="post">
...
<?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc-v2-frontend/resources/views/login/login.blade.php ENDPATH**/ ?>