...
<div class="col-md-12 col-sm-12 col-12">
    <div class="card">
        <div class="card-body">
            <form action="<?php echo e(URL::route('downloadlaporankomisisupir')); ?>" method="post">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                        ...
                        <select id="id_supir" name="id_supir" class="selectkas form-control" required>
                            ...
                            <option value="<?php echo e($supir->id_supir); ?>"><?php echo e($supir->nama_supir); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azikasyahputra/Documents/Independent/cpnc/resources/views/laporantrucking/indexlaporankomisisupir.blade.php ENDPATH**/ ?>