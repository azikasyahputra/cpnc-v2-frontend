...
@section('content')
    <div class="col-md-12 col-sm-12 col-12">
        <div class="card">
            <form action="{{URL::route('gudangsaveedit')}}" method="post" class="form-horizontal">
            @foreach($gudang as $data)
                ...
                <div class="card-body ">
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="gudang" class="form-control" name="gudang" value="{{$data->nama_gudang}}" required /></div>
                    </div>
                </div>
