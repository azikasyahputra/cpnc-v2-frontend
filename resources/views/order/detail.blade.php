                        ...
                        @foreach($order as $data)
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="no_container" class="form-control" name="no_container" value="{{$data->no_container}}" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    <label for="id_jenis_dokumen">Jenis Dokumen* :</label>
                                    <input type="text" id="nama_dokumen" class="form-control" name="nama_dokumen" value="{{$data->nama_dokumen}}" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    <label for="nama_kapal_pesawat">Kapal/Pesawat* :</label>
                                    <input type="text" id="nama_kapal_pesawat" class="form-control" name="nama_kapal_pesawat" value="{{$data->nama_kapal_pesawat}}" readonly />
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="tanggal_kapal_pesawat" class="form-control" name="tanggal_kapal_pesawat" value="{{$tanggal_kapal_pesawat}}" readonly />
                                </div>
                            </div>
                             ...
                             <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="nama_pelayaran" class="form-control" name="nama_pelayaran" value="{{$data->nama_pelayaran}}" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    <label for="id_lapangan">Lapangan *:</label>
                                    <input type="text" id="nama_lapangan" class="form-control" name="nama_lapangan" value="{{$data->nama_lapangan}}" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="nama_gudang" class="form-control" name="nama_gudang" value="{{$data->nama_gudang}}" readonly />
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="nama_barang" class="form-control" name="nama_barang" value="{{$data->nama_barang}}" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    <label for="nama_bl">BL* :</label>
                                    <input type="text" id="nama_bl" class="form-control" name="nama_bl" value="{{$data->nama_bl}}" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    <label for="nama_pos">Pos* :</label>
                                    <input type="text" id="nama_pos" class="form-control" name="nama_pos" value="{{$data->nama_pos}}" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    <label for="id_kosongan">Kosongan *:</label>
                                    <input type="text" id="nama_kosongan" class="form-control" name="nama_kosongan" value="{{$data->nama_kosongan}}" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    <label for="id_status">Status* :</label>
                                    <input type="text" id="nama_status" class="form-control" name="nama_status" value="{{$data->nama_status}}" readonly />
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="tanggal_status" class="form-control" name="tanggal_status" value="{{$tanggal_status}}" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    <label for="negara_asal">Negara Asal/Tujuan* :</label>
                                    <input type="text" id="negara_asal_tujuan" class="form-control" name="negara_asal_tujuan" value="{{$data->negara_asal_tujuan}}" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-12 mb-3 ">
                                    <a href="{{URL::route('orderedit',['id'=>$data->id_order])}}" class="btn btn-warning">Edit</a>
