...
@section('content')
    <div class="col-md-12 col-sm-12 col-12">
        <form action="{{URL::route('ordersaveedit')}}" method="post">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="kemasan" class="form-control" name="kemasan" value="{{$data->kemasan}}" />
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    <label for="no_container">No.Container* :</label>
                                    <input type="text" id="no_container" class="form-control" name="no_container" value="{{$data->no_container}}" required />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    @foreach($jenisdokumen as $jenisdokumen)
                                        <option value="{{$jenisdokumen->id_jenis_dokumen}}" @if($data->id_jenis_dokumen==$jenisdokumen->id_jenis_dokumen) selected @endif>{{$jenisdokumen->nama_dokumen}}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="nama_kapal_pesawat" class="form-control" name="nama_kapal_pesawat" value="{{$data->nama_kapal_pesawat}}" required />
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="tanggal_kapal_pesawat" class="form-control" name="tanggal_kapal_pesawat" value="{{$tanggal_kapal_pesawat}}" required />
                                </div>
                            </div>
                             ...
                             <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    @foreach($pelayaran as $pelayaran)
                                        <option value="{{$pelayaran->id_pelayaran}}" @if($data->id_pelayaran==$pelayaran->id_pelayaran) selected @endif>{{$pelayaran->nama_pelayaran}}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    @foreach($lapangan as $lapangan)
                                        <option value="{{$lapangan->id_lapangan}}" @if($data->id_lapangan==$lapangan->id_lapangan) selected @endif>{{$lapangan->nama_lapangan}}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    @foreach($gudang as $gudang)
                                        <option value="{{$gudang->id_gudang}}" @if($data->id_gudang==$gudang->id_gudang) selected @endif>{{$gudang->nama_gudang}}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="nama_barang" class="form-control" name="nama_barang" value="{{$data->nama_barang}}" required />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    <label for="nama_bl">BL* :</label>
                                    <input type="text" id="nama_bl" class="form-control" name="nama_bl" value="{{$data->nama_bl}}" required />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    <label for="nama_pos">Pos* :</label>
                                    <input type="text" id="nama_pos" class="form-control" name="nama_pos" value="{{$data->nama_pos}}" required />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    ...
                                    @foreach($kosongan as $kosongan)
                                        <option value="{{$kosongan->id_kosongan}}" @if($data->id_kosongan==$kosongan->id_kosongan) selected @endif>{{$kosongan->nama_kosongan}}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    @foreach($status as $status)
                                        <option value="{{$status->id_status}}" @if($data->id_status==$status->id_status) selected @endif>{{$status->nama_status}}</option>
                                    @endforeach
                                    </select>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                                    ...
                                    <input type="text" id="tanggal_status" class="form-control" name="tanggal_status" value="{{$tanggal_status}}" required />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 ">
                                    <label for="negara_asal">Negara Asal/Tujuan* :</label>
                                    <input type="text" id="negara_asal_tujuan" class="form-control" name="negara_asal_tujuan" value="{{$data->negara_asal_tujuan}}" required />
                                </div>
                            </div>
                        </div>
                    </div>
