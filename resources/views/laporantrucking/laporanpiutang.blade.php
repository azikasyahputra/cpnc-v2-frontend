...
<body>
  ...
  <table width="100%">
    ...
    <tbody>
      ...
      <?php $cetak = 'akhir'; ?>
      @endif
      @if($datapiutang[1]!='kosong' && $datapiutang[2]!='kosong')
      <tr>
        ...
        <td align="right" class="propertyisi" width="7%">{{number_format($datapiutang[3],0,'','.')}}</td>
        <td align="right" class="propertyisi" width="7%">{{number_format($datapiutang[4],0,'','.')}}</td>
      ...
      <tr>
        ...
        <td colspan="1"></td>
        <td align="right" class="propertyhasil" width="8%">{{number_format($datapiutang[3],0,'','.')}}</td>
        <td align="right" class="propertyhasil" width="8%">{{number_format($datapiutang[4],0,'','.')}}</td>
