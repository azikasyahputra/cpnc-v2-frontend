                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                @foreach($referensi as $referensi)
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 mb-3 "> 
                                        ...
                                        <input type="text" id="pendapatan" class="form-control text-end" name="pendapatan" value="{{$header->pendapatan}}" readonly />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 mb-3 "> 
                                        ...
                                        <input type="text" id="piutang" class="form-control text-end" name="piutang" value="{{$header->piutang}}" readonly />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 mb-3 "> 
                                        ...
                                        <input type="text" id="kas" class="form-control text-end" name="kas" value="{{$header->kas}}" readonly />
                                    ...
                                    <?php $no=1; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" id="jumlah_biaya_{{$no}}" class="cost form-control text-end" name="jumlah_biaya_{{$no}}" value="{{$detaildata->biaya_detail}}" readonly/>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="sum" class="form-control text-end" name="jumlah_pendapatan" value="{{$header->jumlah_biaya}}" readonly /></td>
