        ...
        <div class="card-body">
            ...
            <div id="order">
                ...
                <div class="card-body">
                    ...
                    <form action="{{URL::route('pengeluaransaveedit')}}" method="post">

                        {{ csrf_field() }}

                        @foreach($header as $header)

                        <input type="hidden" name="id_pengeluaran" value="{{$header->id_pengeluaran}}">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                @foreach($referensi as $referensi)
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 mb-3 "> 
                                        ...
                                        <input type="text" id="pendapatan" class="form-control text-end" name="pendapatan" value="{{$header->pendapatan}}" required />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 mb-3 "> 
                                        ...
                                        <input type="text" id="piutang" class="form-control text-end" name="piutang" value="{{$header->piutang}}" required />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 mb-3 "> 
                                        ...
                                        <input type="text" id="kas" class="form-control text-end" name="kas" value="{{$header->kas}}" required />
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-2 col-sm-2 col-xs-2 mb-3 ">
                                        ...
                                        <input type="text" id="no_bl" class="form-control" name="no_bl" value="{{$header->kode_jenis_invoice}}" readonly />
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" id="berangkat_tiba" class="form-control" name="berangkat_tiba" value="{{$header->tanggal_berangkat}}" readonly />

                                        </td>

                                        <td>

                                            <input type="text" id="banyaknya_kemasan" class="form-control" name="banyaknya_kemasan" value="{{$header->nama_kemasan}}" readonly />
                        ...
                        <div class="row">
                            ...
                            <table class="table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <input type="hidden" name="id_pengeluaran_dt_{{$no}}" value="{{$detaildata->id_pengeluaran_dt}}" />
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" id="sum" class="form-control" name="jumlah_pendapatan text-end" value="{{$header->jumlah_biaya}}" required /></td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-12 mb-3 ">
                                ...
                                <a href="{{URL::route('pengeluaran')}}" class="btn btn-danger">Batal</a>
