...
<body>
  ...
  <table width="100%">
     ...
     <tr>
        ...
        <td class="propertyisi" width="10%" align="right">{{number_format($totalkas,0,'','.')}}</td>
        <td class="propertyheader" align="right" style="border-right: 0px;" width="10%">&nbsp;</td>
        <td class="propertyisi" width="10%">Utang Usaha</td>
        <td class="propertyisi" width="10%" align="right">{{number_format($utangusaha,0,'','.')}}</td>
      </tr>
      <tr>
        ...
        <td class="propertyisi" width="10%" align="right">{{number_format($utangpajak,0,'','.')}}</td>
      </tr>
      <tr>
        <td class="propertyheader" align="right" style="border-right: 0px;" width="10%">&nbsp;</td>
        <td class="propertyisi" width="10%">Piutang</td>
        <td class="propertyisi" width="10%" align="right">{{number_format($piutang,0,'','.')}}</td>
      ...
      <tr>
        ...
        <td class="propertyisi" width="10%" align="right">{{number_format($inventaris,0,'','.')}}</td>
        <td class="propertyheader" align="right" style="border-right: 0px;" width="10%">&nbsp;</td>
        <td class="propertyisi" width="10%">Modal Disetor</td>
        <td class="propertyisi" width="10%" align="right">{{number_format($modaldisetor,0,'','.')}}</td>
      </tr>
      <tr>
        <td class="propertyheader" align="right" style="border-right: 0px;" width="10%">&nbsp;</td>
        <td class="propertyisi" width="10%">Penambahan Aktiva</td>
        <td class="propertyisi" width="10%" align="right">{{number_format($penambahanaktiva,0,'','.')}}</td>
        <td class="propertyheader" align="right" style="border-right: 0px;" width="10%">&nbsp;</td>
        <td class="propertyisi" width="10%">Laba (Rugi) Tahun Berjalan</td>
        <td class="propertyisi" width="10%" align="right">{{number_format($labarugiberjalan,0,'','.')}}</td>
      </tr>
      <tr>
        <td class="propertyheader" align="right" style="border-right: 0px;" width="10%">&nbsp;</td>
        <td class="propertyisi" width="10%">Akumulasi Penyusutan</td>
        <td class="propertyisi" width="10%" align="right">{{number_format($akumulasipenyusutan,0,'','.')}}</td>
        <td class="propertyheader" align="right" style="border-right: 0px;" width="10%">&nbsp;</td>
        <td class="propertyisi" width="10%">Laba (Rugi) Tahun Lalu</td>
        <td class="propertyisi" width="10%" align="right">{{number_format($labarugilalu,0,'','.')}}</td>
      </tr>
      <tr>
        <td class="propertyheader" colspan="2">&nbsp;</td>
        <td class="propertyisi" width="10%" align="right">-</td>
      ...
      <tr>
        ...
        <td class="propertyisi" width="10%" align="right">{{number_format($jumlahaktiva,0,'','.')}}</td>
        <td class="propertyheader" colspan="2">JUMLAH KEWAJIBAN DAN EKUITAS</td>
        <td class="propertyisi" width="10%" align="right">{{number_format($jumlahkewajiban,0,'','.')}}</td>
      </tr>
